...
class MISTDataset(Dataset):
    def __init__(self, x_img_dir, y_img_dir, num_pairs=None, transforms=None):
        ...
        self.x_dir_list = [x for x in self.x_dir_list if x.lower().endswith('.jpg')]
    ...
    def __getitem__(self, index):
        ...
        if self.transforms:
            ...
            #basename = os.path.splitext(os.path.basename(x_sample_path))[0]
            basename = os.path.basename(x_sample_path)
        return y, x, basename
